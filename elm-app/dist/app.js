...
var Elm = __webpack_require__(19);
...
var _user$project$Models$Model = F4(
	function (a, b, c, d) {
		return {players: a, route: b, position: c, drag: d};
	});
var _user$project$Models$Player = F3(
	function (a, b, c) {
		return {id: a, name: b, level: c};
	});
var _user$project$Models$Drag = F2(
	function (a, b) {
...
var _user$project$Models$initialModel = function (route) {
	return {
		players: _krisajenkins$remotedata$RemoteData$NotAsked,
		route: route,
		position: A2(_user$project$Models$Position, 300, 300),
		drag: _elm_lang$core$Maybe$Nothing
	};
};
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$DragBlockRoute = {ctor: 'DragBlockRoute'};
...
var _user$project$Msgs$DragStart = function (a) {
...
var _user$project$Commands$fetchPlayersUrl = 'http://localhost:8000/players/';
...
var _user$project$Home_Home$dragBlockBtn = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$dragBlockPath),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Drag Block'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Home_Home$playersBtn = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('btn navBarBtn regular'),
...
var _user$project$Home_Home$body = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('homeBlock'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('textHomeBlock'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'Hello everyone ! :) this is a project !',
						A2(
							_elm_lang$core$Basics_ops['++'],
							'\n We\'ve added here some views with feathers to',
							A2(_elm_lang$core$Basics_ops['++'], ' show You that creating a website in functional language', ' is possible! ')))),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Home_Home$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _user$project$Home_Home$playersBtn,
				_1: {
					ctor: '::',
					_0: _user$project$Home_Home$dragBlockBtn,
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Home_Home$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _user$project$Home_Home$nav,
		_1: {
			ctor: '::',
			_0: _user$project$Home_Home$body,
			_1: {ctor: '[]'}
		}
	});
